...
/**
 * Created by USERPC on 19/10/2017.
 */

public class AdapterHomeMonitor extends RecyclerView.Adapter<AdapterHomeMonitor.ViewHolder> {
    ...
    public AdapterHomeMonitor(List<String> options,int layout, OnItemClickListener itemClickListener) {
